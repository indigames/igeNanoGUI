...
# all available FA icons as they would appear in NanoGUI itself.  For a C++
...
from igeNanoGUI import Screen, Window, Widget, GridLayout, VScrollPanel, Button
from igeNanoGUI import icons
...
if __name__ == "__main__":
    ...
    for key in icons.__dict__.keys():
        if key.startswith("FA_"):
            b = Button(wrapper, "{0}".format(key), icons.__dict__[key])
